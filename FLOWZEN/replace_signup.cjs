...
// We want to replace everything from the first <script> that is NOT a src include,
// or just find the main script block.
const scriptStart = '<script>\n        document.addEventListener(\'DOMContentLoaded\', () => {';
const scriptEnd = '</script>\n\n</body>'; // or however it ends
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    fs.writeFileSync(signupPath, content.substring(0, startIdx) + newScript + '\n</body>\n</html>');
}
